...
//
// /**
// * Text TextView that auto adjusts text size to fit within the view.
...
// */
// @Override
// protected void onTextChanged(final CharSequence text, final int start, final
// int before, final int after) {
// mNeedsResize = true;
...
// lineWidth = textPaint.measureText(text.subSequence(start, --end +
// 1).toString());
// }
...
// private int getTextHeight(CharSequence source, TextPaint originalPaint, int
