 ...
 */
public class IconsTabPageIndicator extends HorizontalScrollView implements
		PageIndicator {
	...
	public IconsTabPageIndicator(Context context) {
		this(context, null);
	}

	public IconsTabPageIndicator(Context context, AttributeSet attrs) {
		super(context, attrs);
